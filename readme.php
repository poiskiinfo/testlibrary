...
Инструкция по тому что нужно зделать чтоб скрипт зараБотал ниже
...
ссылка на видео https://yadi.sk/i/i2jAd2bJO_ISEw что данный проект работает и публикует в гугл таблицы в конец данные за прошлый день пришлось запись msqli поправить на прошлый день чтобу увидеть 1 1 а то показало бы 0 0
